...
// Set the payload in construtor so we can assigned when dispatching
...
// Exporting a type for each class to be able to use it as typescript function in reducer
